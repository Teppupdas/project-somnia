...
func load_game():
	...
	player.max_health = data_file.get_value("player", "max_health", 7) # ustawianie maksymalnego zycia
	player.current_health = data_file.get_value("player", "max_health", 7) # ustawianianie obencego zycia
